    ...
    <div className="h-screen w-full bg-[#0c0d0f] text-[#e0e0e0] font-sans flex flex-col overflow-hidden select-none selection:bg-[#7a49a5]/30">
      ...
      <header className="h-[80px] flex-shrink-0 bg-[#16181d] border-b border-[#2d2f36] px-4 md:px-8 flex items-center justify-between shadow-lg z-10">
        <div className="flex items-center gap-3 md:gap-4">
          <div className="w-10 h-10 bg-[#7a49a5] rounded flex items-center justify-center text-white font-bold text-xl shadow-[0_0_15px_rgba(122,73,165,0.4)]">T</div>
          <div>
        ...
        <div className="hidden md:flex gap-6">
          <div className="flex flex-col items-end">
            ...
            <span className="text-sm text-[#a855f7] font-semibold">Fabric 0.15.11</span>
          </div>
          ...
          <div className="flex flex-col items-end">
            ...
            <button 
              onClick={copyIp} 
              className="flex items-center gap-1.5 text-sm text-[#4ade80] font-mono hover:text-[#a855f7] focus:outline-none transition-colors" 
              title="Copiar IP"
            >
              {serverIp}
              {copied ? <Check className="w-3.5 h-3.5 text-[#4ade80]" /> : <Copy className="w-3.5 h-3.5 text-[#8e9299] hover:text-[#a855f7]" />}
            </button>
          </div>
        </div>
      </header>
              ...
              return (
                <div key={group.type} className="mb-6 last:mb-0">
                  ...
                  <div className="space-y-2">
                    {items.map((mod, index) => (
                      <div key={mod.id} className="bg-[#1a1c23] border border-[#2d2f36] p-3 rounded flex items-center gap-3 hover:border-[#7a49a5] transition-all group relative overflow-hidden">
                        ...
                        <div className="flex-1 min-w-0 relative z-10 flex flex-col justify-center">
                          <div className="flex items-center justify-start gap-1.5 md:gap-2 mb-0.5 md:mb-1 flex-wrap">
                            <h3 className="text-xs md:text-sm font-semibold text-white flex items-center gap-1.5 mr-1">
                              {mod.name}
                              {mod.isRequired && <CheckCircle className="w-3 h-3 text-[#7a49a5] flex-shrink-0" title="Requerido" />}
                            </h3>
                          ...
                          {mod.dependencies && mod.dependencies.length > 0 && (
                            <div className="text-[9px] md:text-[10px] text-[#5b5e66] truncate mt-0.5">
                              <span className="text-[#a855f7]/50 font-semibold mr-1">Requiere:</span>
                        ...
                        <a 
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="relative z-10 flex items-center gap-1.5 px-3 py-1.5 rounded bg-[#2d2f36]/50 hover:bg-[#7a49a5]/20 text-[#a855f7] border border-transparent hover:border-[#7a49a5]/50 transition-all ml-2"
                        >
          ...
          <div className="bg-[#1a1c23] rounded-xl border border-[#2d2f36] p-5 flex flex-col shrink-0">
            ...
            <div className="space-y-4">
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#7a49a5] flex items-center justify-center text-[10px] font-bold text-white shadow-[0_0_8px_rgba(122,73,165,0.4)]">1</div>
                <p className="text-[10px] md:text-[11px] text-[#8e9299]">Descarga el cargador de <a href="https://fabricmc.net/use/installer/" target="_blank" rel="noreferrer" className="text-white hover:text-[#a855f7] hover:underline transition-colors">Fabric Loader</a> para la v1.21.10.</p>
              </div>
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#7a49a5] flex items-center justify-center text-[10px] font-bold text-white shadow-[0_0_8px_rgba(122,73,165,0.4)]">2</div>
                <p className="text-[10px] md:text-[11px] text-[#8e9299]">Presiona <span className="text-white">Win + R</span>, escribe <code className="bg-[#0c0d0f] px-1 py-0.5 rounded text-[#a855f7] border border-[#2d2f36]">%appdata%</code> y entra a <code className="text-white">.minecraft/mods</code>.</p>
              </div>
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#7a49a5] flex items-center justify-center text-[10px] font-bold text-white shadow-[0_0_8px_rgba(122,73,165,0.4)]">3</div>
                <p className="text-[10px] md:text-[11px] text-[#8e9299]">Mueve todos los archivos mod descargados (.jar) dentro de esa carpeta.</p>
              </div>
              <div className="flex gap-3">
                <div className="flex-shrink-0 w-5 h-5 rounded-full bg-[#7a49a5] flex items-center justify-center text-[10px] font-bold text-white shadow-[0_0_8px_rgba(122,73,165,0.4)]">4</div>
            ...
            <div className="mt-5 p-3 md:p-4 bg-[#7a49a5]/10 border border-[#7a49a5]/30 rounded-lg">
              <p className="text-[9px] md:text-[10px] leading-relaxed text-[#c084fc]">
                * Los mods obligatorios (<CheckCircle className="w-2.5 h-2.5 inline mx-0.5 text-[#7a49a5]" />) son indispensables para conectarse. Los demás son para mejorar tu experiencia en el cliente.
              </p>
            </div>
          </div>
        </aside>
